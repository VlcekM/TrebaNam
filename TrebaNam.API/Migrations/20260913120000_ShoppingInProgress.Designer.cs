...
namespace TrebaNam.API.Migrations
{
    ...
    [Migration("20260913120000_ShoppingInProgress")]
    partial class ShoppingInProgress
    {
            ...
            modelBuilder.Entity("TrebaNam.API.ShoppingLists.ShoppingListEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ShoppingStartedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("shopping_started_at");

                    b.Property<Guid?>("ShoppingStartedByUserID")
                        .HasColumnType("uuid")
                        .HasColumnName("shopping_started_by_user_id");
